...
class PositionsController extends Controller
{
    ...
    public function index()
    {
        //
    	    ...
    	    $positions=m_position::where('user_id',$loggeduser->id)->orWhere('leader_id','=',0)->orderBy('start_date', 'desc')->paginate(10);	
			}
			else {
				$positions=m_position::orderBy('start_date', 'desc')->paginate(10);
			}
